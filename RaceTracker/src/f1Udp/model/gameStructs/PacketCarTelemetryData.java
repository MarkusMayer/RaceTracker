...
import f1Udp.model.enums.MfdPanelIndex;
...
//		System.out.println("PacketCarTelemetry Data length: "+packetCarTelemetryData.length+", Data: "+F1UdpReceiver.bytesToHex(packetCarTelemetryData));		
		...
		ByteBuffer bbZoneData = ByteBuffer.wrap(packetCarTelemetryData,0,packetCarTelemetryData.length);
		bbZoneData.get(carTelemetryTotalData,0,carTelemetryTotalData.length);
