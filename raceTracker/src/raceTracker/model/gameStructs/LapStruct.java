...
//		System.out.println("Laps total Data: "+F1UdpReceiver.bytesToHex(lapsData));
		...
		for (int i=0;i<Math.min(numActiveCars, 22);i++) {
			...
			LapStruct aLap=new LapStruct(lapData);
			laps.add(aLap);
			if (i<6) System.out.println(i+","+aLap);
		}
		return laps;
	}
...
//	                                          // 6 = retired
	...
	public LapStruct(float lastLapTime, float currentLapTime, float bestLapTime, float lapDistance, float totalDistance,
	...
	public LapStruct(byte[] lapData) throws IOException {
//		System.out.println("Lap: "+F1UdpReceiver.bytesToHex(lapData));
	...
	public Duration getDeltaLastLapPersonalBestLapTime() {
		return getLastLapTimeDuration().minus(getBestLapTimeDuration());
	}
	...
	public Duration getSector1Time() {
	...
	public Duration getSector2Time() {
	...
	public Duration getBestLapSector1Time() {
	...
	public Duration getBestLapSector2Time() {
	...
	public Duration getBestLapSector3Time() {
	...
	public Duration getBestOverallSector1Time() {
	...
	public Duration getBestOverallSector2Time() {
	...
	public Duration getBestOverallSector3Time() {
	...
	public int getDeltaPosition() {
		return getGridPosition() - getCarPosition();
	}
	
	public Duration getDeltaPersonalS1BestLap(Duration s1Time) {
		return getDeltaPersonalBestLapSector(getBestLapSector1Time(), s1Time);
	}
	
	public Duration getDeltaPersonalS1BestLap() {
		return getDeltaPersonalS1BestLap(getSector1Time());
	}
	
	public Duration getDeltaPersonalS2BestLap(Duration s2Time) {
		return getDeltaPersonalBestLapSector(getBestLapSector2Time(), s2Time);
	}
	
	public Duration getDeltaPersonalS2BestLap() {
		return getDeltaPersonalS2BestLap(getSector2Time());
	}
	
	public Duration getDeltaPersonalS1Best(Duration s1Time) {
		return getDeltaPersonalBestSector(getBestOverallSector1Time(), s1Time);
	}
	
	public Duration getDeltaPersonalS1Best() {
		return getDeltaPersonalS1Best(getSector1Time());
	}
	
	
	public Duration getDeltaPersonalS2Best(Duration s2Time) {
		return getDeltaPersonalBestSector(getBestOverallSector2Time(),s2Time);
	}
	
	public Duration getDeltaPersonalS2Best() {
		return getDeltaPersonalS2Best(getSector2Time());
	}
	
	private Duration getDeltaPersonalBestLapSector(Duration personalBestLapSectorTime, Duration lastSectorTime) {
		return personalBestLapSectorTime.equals(Duration.ZERO) || lastSectorTime.equals(Duration.ZERO) ? Duration.ZERO :lastSectorTime.minus(personalBestLapSectorTime);
	}
	
	private Duration getDeltaPersonalBestSector(Duration personalBestSectorTime, Duration lastSectorTime) {
		return lastSectorTime.equals(Duration.ZERO) ? Duration.ZERO :lastSectorTime.minus(personalBestSectorTime);
	}
